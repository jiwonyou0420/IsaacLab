...
from isaaclab_assets.robots.universal_robots import UR5_XARM_GRIPPER_CFG  # isort: skip
    ...
    def __post_init__(self):
        ...
        self.actions.gripper_action = mdp.BinaryJointPositionActionCfg(
            ...
            close_command_expr={
                ...
                # "right_inner_knuckle_joint": 0.0,
                # "right_outer_knuckle_joint": 0.0,
                "drive_joint": 0.8, # from GUI inspection, gripper joint angle was 0 when open and ~40deg when closed -> would be ~0.7 in radian?
            },
        )
