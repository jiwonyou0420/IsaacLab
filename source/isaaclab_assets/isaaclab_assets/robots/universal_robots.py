...
UR5_XARM_GRIPPER_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path="/home/andres/Documents/jiwon/isaacsim_scenes/ur5_with_xarm_gripper_new.usd",
        activate_contact_sensors=False,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            max_depenetration_velocity=5.0,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        joint_pos={
            ...
            "shoulder_lift_joint": -1.9,   # ~-98 deg
            "elbow_joint":          1.9,   # ~+98 deg
            "wrist_1_joint":        -1.9,
            "wrist_2_joint":        -1.6,
            "wrist_3_joint":        -1.7,
...
UR10_ROBOTIQ_2F_140_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAAC_NUCLEUS_DIR}/Samples/Rigging/Manipulator/configure_manipulator/ur10e/ur/ur_gripper.usd",
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            max_depenetration_velocity=5.0,
        ),
...
UR5_ROBOTIQ_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        # your mounted robot+gripper USD
        usd_path="/home/andres/Documents/jiwon/isaacsim_scenes/ur5_with_robotiq_gripper_new.usd",
        activate_contact_sensors=False,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            max_depenetration_velocity=5.0,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        joint_pos={
            ...
            # Choose an "open" default that won’t collide:
            "finger_joint":                 0.0,   # often the driven transmission input
        },
        # If you want initial joint velocities, add "joint_vel={...}" here
    ),
    ...
    actuators={
        ...
        # Robotiq gripper: group all mechanical joints of the gripper
        # (You will still expose ONE "gripper" action later in your env cfg.)
